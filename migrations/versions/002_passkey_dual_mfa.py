...
def upgrade():
    ...
    with op.batch_alter_table("user") as batch_op:
        ...
        batch_op.add_column(
            sa.Column("mfa_totp_enabled", sa.Boolean(), nullable=False, server_default=sa.false())
        )
        batch_op.add_column(
            sa.Column("mfa_email_enabled", sa.Boolean(), nullable=False, server_default=sa.false())
        )
